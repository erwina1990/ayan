...
if (isset($_GET['txt']))
    $_POST['filter']['cf_1410'] = $_GET['txt'];
if (isset($_POST['filter']))
    $contracts = getMediumContract($_POST['filter']);
else
    $contracts = getMediumContract();
if (isset($_GET['id']))
    $contracts = getMediumContractById($_GET['id']);
$contractorList = getContractorList();
$contracType = getcontracType();
?>
    <ul class="SiteMap">
        <li><a href="/">صفحه اول</a></li>
        <i class="mdi mdi-chevron-left"></i>
        <li>قراردادهای متوسط</li>
    </ul>
                ...
                <div align="center" class="table-responsive display-table-pc" style="max-height: 700px">
                    <table class="table widefat table-gharardad-kalan table-bordered table-hover" dir="rtl" border="1"
                        ...
                        <tr class="trInputs">
                            ...
                            <td>
                                <input type="text" name="filter[cf_1410]"
                                       value="<?php if (isset($_POST['filter']['cf_1410'])
                            ...
                            <td>
                                <select name="filter[cf_1660]">
                                    <option value=""></option>
                                    <?php
                                    foreach ($contracType as $contractor):
                                        ?>
                                        <option value="<?php echo $contractor['cf_1660'] ?>"
                                            <?php if (isset($_POST['filter']['cf_1660']) && $_POST['filter']['cf_1660'] == $contractor['cf_1660']) echo 'selected'; ?>
                                        ><?php
                                            echo $contractor['cf_1660'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </td>
                        </tr>
                        ...
                        if ($contracts) {
                            ...
                            foreach ($contracts as $contract):
                                ...
                                <tr>
                                    ...
                                    <td><?php echo number_format($contract['cf_1426'] / 1000000); ?> میلیون ریال</td>
                                    <td><?php echo $contract['mediumcontract_tks_durationtom']; ?></td>
                                    <td><?php echo $contract['cf_1412']; ?></td>
                                    <td><?php echo $contract['cf_1660']."<br>"; ?></td>
                                </tr>
                                <?php
                                $count++;
                            endforeach;
        ...
        <div class="display-table-mob">
            <form method="post">
                ...
                <div id="resultSearch" style="position: relative;top: 2px;left: 0;right: 0;background: #33D456;">
                    <span style="font-size: 12px;color: #fff;">تعداد کل قراردادهای متوسط و خرد: <?php echo $count - 1; ?></span>
                </div>
                <table class="table widefat  table-tender1  table-bordered  table-striped"
                    ...
                    <div class="trInputsMob">
                        ...
                        <div>
                            <input type="text" placeholder=" موضوع قرارداد " name="filter[cf_1410]"
                                   value="<?php if (isset($_POST['filter']['cf_1410'])
                                       && !empty($_POST['filter']['cf_1410'])) echo $_POST['filter']['cf_1410'] ?>">
                        </div>
                        <div>
                    ...
                    <tr>
                        <th>نوع قرارداد</th>
                        <td><?php echo $contract['cf_1660']; ?></td>
                    </tr>
                    <?php
                    $count++;
                    endforeach;
