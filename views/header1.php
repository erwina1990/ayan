                            ...
                            <div class="">
                                ...
                                <nav class="cd-dropdown">
                                    ...
                                    <ul class="cd-dropdown-content">
                                        ...
                                        <li class="has-children"> <a href="#">قرارداد</a>
                                            <ul class="cd-dropdown-icons is-hidden">
                                                <li class="go-back"><a href="#0">بازگشت</a></li>
                                                <li>
                                                    <a class="cd-dropdown-item item-1"
                                                       href="<?php echo URLhome ?>views_2/hcontract.php">
                                                        قراردادهای کلان
                                                    </a>
                                                </li>
                                                <li>
                                        ...
                                        <li><a href="<?php echo URLhome ?>views/shoraha.php">اطلاعات شورای شهر</a></li>
                                    ...
                                    foreach ($result as $res):
                                        ...
                                        <li>
                                            <h6><a class="cd-nowrap"
                                                   href="<?php echo $res['type'] ?>.php?id=<?php echo $res['id'] ?>&txt=<?php echo $title ?>">
