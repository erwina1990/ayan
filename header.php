...
<head>
    ...
    <link rel="stylesheet" href="css/index2-animate.css">
    <script src="js_2/modernizr.js"></script>
    <script src="js_2/search-toggle-mobile.js"></script>
...
<script>
   ...
   document.getElementsByClassName('fix-img').style.color = 'green';
    document.getElementsByClassName('fix-img').style.height= "600px"*/
   /*window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight*/
</script>
<div class="fix-img" id="op" ></div>
<div class="first-body " id="first-1">
    <h1 hidden>سامانه شفافیت شهرداری اراک</h1>
     <div id="cover-display"  style=""></div>
    <div class="mainBODY">
        <div class="header-menu" id="header1">
                            ...
                            <div class="">
                                ...
                                <nav class="cd-dropdown">
                                    ...
                                    <ul class="cd-dropdown-content">
                                        ...
                                        <li><a href="<?php echo URLhome ?>amlak_2/amlakShahrdari.php">املاک شهرداری</a></li>
                                    ...
                                    foreach ($result as $res):
                                        ...
                                        <li>
                                            <h6><a class="cd-nowrap"
                                                   href="views/<?php echo $res['type'] ?>.php?id=<?php echo $res['id'] ?>&txt=<?php echo $title ?>$last-time=<?php echo $lasttime ?>">
